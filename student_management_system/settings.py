...
# SECURITY WARNING: don't run with debug turned on in production!You’re seeing this error because you have DEBUG = True in your Django settings file.
...
AUTHENTICATION_BACKENDS = [
    'student_management_app.EmailBackEnd.EmailBackEnd',  # custom email login
